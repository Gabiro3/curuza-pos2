...
import { Loader2, Search, CalendarIcon, Check, Plus, Edit, Trash } from 'lucide-react';
import {
    Select,
    SelectContent,
    SelectItem,
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Create and manage purchase plans for your inventory
                    </p>
                </div>
                            ...
                            <CardHeader>
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <CardDescription>
                                            Planned for {formatDate(currentPlan.planned_date)}
                                        </CardDescription>
                                    </div>
                                    {currentPlan.status === 'draft' && (
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <Button
                                                variant="default"
                                                size="sm"
                                                onClick={() => updatePlanStatus('scheduled')}
                                            >
                                    ...
                                    {currentPlan.status === 'scheduled' && (
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <Button
                                                variant="destructive"
                                                size="sm"
                                                onClick={() => updatePlanStatus('cancelled')}
                                            >
                                                Cancel
                                            </Button>
                                        </div>
                                            ...
                                            <TableBody>
                                                ...
                                                <TableRow>
                                                    ...
                                                    <TableCell className="font-bold">
                                                        {formatCurrency(currentPlan.total_cost)}
                                                    </TableCell>
                        ...
                        <Card>
                            <CardContent className="flex items-center justify-center min-h-[400px]">
                                <div className="text-center">
                                    ...
                                    <p className="text-muted-foreground">
                                        Select an existing plan from the sidebar or create a new one
                                    </p>
                                    <Button
                                        className="mt-4"
            ...
            <Dialog open={isPlanFormDialogOpen} onOpenChange={setIsPlanFormDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>
                            {isEditingPlan ? 'Edit Purchase Plan' : 'Create Purchase Plan'}
                        </DialogTitle>
                        <DialogDescription>
                            {isEditingPlan
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea
                                                placeholder="Any additional information about this purchase plan"
                                                {...field}
                                            />
                                        </FormControl>
                                        <FormMessage />
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Select a product and specify quantity to add to the plan
                        </DialogDescription>
                    </DialogHeader>
                    <Form {...itemForm}>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormDescription>
                                            Default value is the current purchase price
                                        </FormDescription>
                                        <FormMessage />
                                    </FormItem>
                                )}
